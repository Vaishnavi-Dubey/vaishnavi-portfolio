...
/**
 * Subtle animated film-grain overlay. Pure SVG noise — no images needed.
 */
export default function GrainOverlay() {
  return (
    <div
      aria-hidden
      className="pointer-events-none fixed inset-0 z-[55] mix-blend-overlay opacity-[0.10] animate-grain"
      style={{
        backgroundImage:
